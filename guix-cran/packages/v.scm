...
(define-public r-vascr
  (package
    ...
    (source
     (origin
       (method url-fetch)
       (uri (cran-uri "vascr" version))
       (sha256
        (base32 "1fqi965p9wpz60m8fac4lwb3g3536cyl2c5vpn0lsv718v27fyl4"))))
    (properties `((upstream-name . "vascr")))
    (build-system r-build-system)
    (arguments
     (list
      #:tests? #f))
    (propagated-inputs (list r-tidyr
                             ...
                             r-dofuture
                             r-cli))
    (home-page "https://github.com/JamesHucklesby/vascr")
    (synopsis "Process Biological Impedance Sensing Data")
    (description
     "Process complex impedance sensing datasets, including those generated by ECIS,
@code{xCELLigence} and @code{cellZscope} instruments.  Data can be imported to a
standardised tidy format and then plotted.  Support for conducting and plotting
the outputs of ANOVA (with appropriate tests of statistical assumptions) and
cross-correlation analysis.  For data processed using this package see Hucklesby
et al. (2020) <doi:10.3390/bios11050159>.")
    (license license:gpl3+)))
