  ...
  (package
    ...
    (source
     (origin
       ...
       (sha256
        (base32 "1y8whbl8l4dfk06gh5x7rffihzvvfhbphxgm1xy9hnk95k2rhamb"))))
  ...
  (package
    ...
    (source
     (origin
       ...
       (sha256
        (base32 "1lvhviwihqh8w5a8ca7xvlrv407r4b2ahflj24rfx1z66628am78"))))
    ...
    (description
     "Updated versions of the 1970s \"US State Facts and Figures\" objects from the
datasets package included with R. The new data is compiled from a number of
sources, primarily from the United States Census Bureau or the relevant federal
agency.  Modern tidy tibbles provide richer state-level data including
identifiers, geography, capitals, demographics, and socioeconomic statistics.
Convenience vectors parallel the base datasets state objects but extend coverage
  ...
  (package
    ...
    (source
     (origin
       ...
       (sha256
        (base32 "0gk8xin1kqb1g7l1zg36gsrzgfxc7wxmyz476ida6il6r0igyqh5"))))
  ...
  (package
    ...
    (source
     (origin
       ...
       (sha256
        (base32 "183j3l194xlp6w0k1f5xac64wih16p9qbib50ak4zlyczk1jb32p"))))
  ...
  (package
    ...
    (source
     (origin
       ...
       (sha256
        (base32 "0shk03j8nb6sql03lj37z8ng47hxyxvfns1n01vd7p196nw6lfgr"))))
  ...
  (package
    ...
    (source
     (origin
       ...
       (sha256
        (base32 "0rqz0jhnhn50s629r1xpd6cbgs2s5ws8pgw7h2ig6fic0g6746sy"))))
...
(define-public r-ume
  (package
    ...
    (propagated-inputs (list r-viridis
                             ...
                             r-data-table))
    (native-inputs (list r-knitr))
    (home-page "https://gitlab.awi.de/bkoch/ume")
    (synopsis
     "Ultrahigh-Resolution Mass Spectrometry Data Evaluation for Complex Organic Matter")
    (description
     "This package provides tools for assigning molecular formulas from exact masses
obtained by ultrahigh-resolution mass spectrometry.  The methodology follows the
...
formula data and includes utilities for calculating common molecular parameters
(e.g., double bond equivalents, DBE).  A graphical user interface is available
via the shiny'-based ume application.")
    (license license:expat)))
...
\"Making better use of local data in flood frequency estimation\", Environment
Agency (2017, ISBN: 978 1 84911 387 8). \"Sampling uncertainty of UK design flood
estimation\" , Hammond (2021, <doi:10.2166/nh.2021.059>). \"The FEH 2025
statistical method update\", UK Centre for Ecology and Hydrology (2025). \"Low
flow estimation in the United Kingdom\", Institute of Hydrology (1992, ISBN 0
948540 45 1).  Data from the UK National River Flow Archive
  ...
  (package
    ...
    (source
     (origin
       ...
       (sha256
        (base32 "15x5phx2icpvdvqw5hl6wm9nll8q3zbz6rfvnbn6hjs4y0zhyz1p"))))
  ...
  (package
    ...
    (source
     (origin
       ...
       (sha256
        (base32 "1jgx482v25c0bsi6ybiavmz4q8g1zzkbpcxgar8wvdj81a1vqpcx"))))
