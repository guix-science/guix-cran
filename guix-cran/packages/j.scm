  ...
  (package
    ...
    (source
     (origin
       ...
       (sha256
        (base32 "1m89dgldg0rs20nlfsyqrqqv7k1yc9kkbza92ni83x48z0a2y2vn"))))
  ...
  (package
    ...
    (source
     (origin
       ...
       (sha256
        (base32 "0zhj9f523n1s8vb5pidb7zv8p88yx2xqg5kj7r3ls9wv7s5n1hjv"))))
...
(define-public r-jagstree
  (package
    ...
    (propagated-inputs (list r-tidyverse
                             ...
                             r-autowmm))
    (native-inputs (list r-knitr))
    (home-page "https://github.com/malfly/JAGStree")
    (synopsis
     "Automatically Write 'JAGS' Code for Hierarchical Bayesian Models on Trees")
    (description
     "When relationships between sources of data can be represented by a tree, the
generation of appropriate Markov Chain Monte Carlo modeling code to be used with
JAGS to run a Bayesian hierarchical model can be automatically generated by this
package.  Any admissible tree-structured data can be used, under the assumption
that node counts are multinomial and branching probabilities are Dirichlet among
sibling groups.  The methodological basis used to create this package can be
found in Flynn (2023) <http://hdl.handle.net/2429/86174>.")
    (license license:gpl2+)))
