  ...
  (package
    ...
    (source
     (origin
       ...
       (sha256
        (base32 "0511h0q80vi2876xsm2mrnczcl2bp8phvjslv2p8wwpwwmwgds15"))))
  ...
  (package
    ...
    (source
     (origin
       ...
       (sha256
        (base32 "12p99yknf0adzyswi7p3xr8qplzmf3w1scgnjl2mfz8kir7ncw6f"))))
...
(define-public r-kdemcmc
  (package
    ...
    (description
     "This package provides methods for selecting the optimal bandwidth in kernel
density estimation for dependent samples, such as those generated by Markov
chain Monte Carlo (MCMC).  Implements a modified biased cross-validation
(@code{mBCV}) approach that accounts for sample dependence, improving the
accuracy of estimated density functions.")
    (license license:gpl3+)))
