...
<http://bioconductor.org/packages/rtracklayer>, Biostrings (H. @code{Pag̬s} and
al. (2020) <doi:10.18129/B9.bioc.Biostrings>)
...
The @code{keyATM} is proposed in Eshima, Imai, and Sasaki (2023)
