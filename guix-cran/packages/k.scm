...
topological spaces using kernels and geometric graphsâ <arXiv:2010.01768>, and
...
Modelsâ.  arXiv preprint <arXiv:2105.11659>.")
    (license license:gpl2+)))
...
estimation is presented in GonzÃ¡lez and Moraga (2022). <arXiv:2208.12026>.")
    (license license:expat)))
...
(define-public r-kernelshap
  (package
    ...
    (source (origin
              ...
              (sha256
               (base32
                "0z1f6ld9bh1pdv65c6igzc11jny9lcsp6476sxjgnazvi3n8gpj4"))))
...
<https://dl.acm.org/doi/10.5555/3295222.3295230>, and Covert and Lee (2021)
<http://proceedings.mlr.press/v130/covert21a>.  For models with up to eight
features, the results are exact regarding the selected background data.
Otherwise, an almost exact hybrid algorithm involving iterative sampling is
used.  The package plays well together with meta-learning packages like
