...
(define-public r-autohd
  (package
    (name "r-autohd")
    (version "0.1.0")
    (source (origin
              (method url-fetch)
              (uri (cran-uri "autohd" version))
              (sha256
               (base32
                "14wyiqhmbp8v52s1p5svvcjpwg8pwqrqh3zzm17blcl2hr4p9cy8"))))
    (properties `((upstream-name . "autohd")))
    (build-system r-build-system)
    (propagated-inputs (list r-usethis
                             r-tibble
                             r-survregcenscov
                             ...
                             r-coxme
                             r-broom))
    (home-page "https://cran.r-project.org/package=autohd")
    (synopsis "High Dimensional Bayesian Survival Mediation Analysis")
    (description
     "Perform mediation analysis for time to event high-dimensional data.  Mediation
Analysis proposed by Miocevic et al.(2017) <doi:10.1080/10705511.2017.1342541>
as a statistical tool in the Bayesian framework.  Time to event data analysis
methods like Cox proportional hazard model, accelerated failure time model to
work with high dimensional data with Bayesian approaches are provided.  Missing
data imputation techniques tool to work with high dimensional data coupled for
mediation analysis by presented by the active mediator variables.")
    (license license:gpl3)))
...
(define-public r-annoprobe
  (package
    ...
    (source (origin
              ...
              (sha256
               (base32
                "182m711l5m037mfyvr6334pmv338fxb3007j6713abvylsh6x06q"))))
    (properties `((upstream-name . "AnnoProbe")))
    (build-system r-build-system)
    (propagated-inputs (list r-pheatmap r-ggpubr r-ggplot2 r-dt r-biobase))
