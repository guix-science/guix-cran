...
Vecchia, D., & Linton, O. B. (2021) <doi:10.1016/j.jeconom.2020.04.014> describe
the application with the Center for Research in Security Prices (CRSP) Bond Data
...
(define-public r-yamlet
  (package
    ...
    (source (origin
              ...
              (sha256
               (base32
                "0j2i2bn3s0p6jws46xwd6y3bj89kzy53vxbbdp53fy2bgrw136qy"))))
...
(define-public r-yahoofinancer
  (package
    ...
    (source (origin
              ...
              (sha256
               (base32
                "1zr5hpafqzx6h9qfx7b1ji19kzkh19gz1h1x37rx1256anrc07zq"))))
